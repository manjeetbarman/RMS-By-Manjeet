...
class CourseClass:
    def __init__(self,root):
        ...
        #Widget
        lbl_courseName=Label(self.root,text="Course Name",font=("goudy old style",15,'bold'),bg='grey').place(x=10,y=60)
        lbl_duration=Label(self.root,text="Duration",font=("goudy old style",15,'bold'),bg='grey').place(x=10,y=100)
        lbl_charges=Label(self.root,text="Changes",font=("goudy old style",15,'bold'),bg='grey').place(x=10,y=140)
        lbl_description=Label(self.root,text="Description",font=("goudy old style",15,'bold'),bg='grey').place(x=10,y=180)
       ...
       #Search
        ...
        lbl_search_courseName=Label(self.root,text="Course Name",font=("goudy old style",15,'bold'),bg='grey').place(x=720,y=60)
